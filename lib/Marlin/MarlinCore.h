...
public:
    ...
    static void kill(FSTR_P const lcd_error = nullptr,
    ...
    static void wait_for_user_response(millis_t ms = 0,
    ...
    static void end_waiting() {
        TERN_(HAS_RESUME_CONTINUE, wait_for_user =) wait_for_heatup = false;
    }
