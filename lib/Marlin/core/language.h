...
//
//   ==> ALWAYS TRY TO COMPILE MARLIN WITH/WITHOUT "ULTIPANEL" / "ULTRA_LCD" /
//   "SDSUPPORT" #define IN "Configuration.h"
...
#define STR_FLOWMETER_FAULT \
    "Coolant flow fault. Flowmeter safety is active. Attention required."
#define STR_ERR_STOPPED                                                      \
...
#define STR_KI " Ki: "
#define STR_KD " Kd: "
#define STR_PID_AUTOTUNE_FINISHED                                      \
    " finished! Put the last Kp, Ki and Kd constants from below into " \
    "Configuration.h"
...
#define STR_MPC_AUTOTUNE_FINISHED \
...
#define STR_REDUNDANCY                                                         \
    "Heater switched off. Temperature difference between temp sensors is too " \
    "high !"
...
#define STR_DELTA_SETTINGS                                       \
    "Delta (L<diagonal-rod> R<radius> H<height> S<seg-per-sec> " \
    "XYZ<tower-angle-trim> ABC<rod-trim>)"
...
#define STR_ACCELERATION_P_R_T                                  \
    "Acceleration (units/s2) (P<print-accel> R<retract-accel> " \
    "T<travel-accel>)"
...
#define LCD_STR_BEDTEMP \
    "\x00"  // Print only as a char. This will have 'unexpected' results when
            // used in a string!
...
#else
//
// Custom characters from Marlin_symbols.fon which was merged into
// ISO10646-0-3.bdf
...
// Maximum here is 0x1F because 0x20 is ' ' (space) and the normal charsets
// begin. Better stay below 0x10 because DISPLAY_CHARSET_HD44780_WESTERN begins
// here.
